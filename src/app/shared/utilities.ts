 ...
 * @param {boolean} [isForId=false] If `true`, the function will format the string to be a valid HTML `id`.
 * @return {string} The normalized string, without accents and in lowercase. If `isForId` is `true`, the string will be further transformed into a valid `id` format.
