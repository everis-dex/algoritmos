...
export const mockAlgorithmicSystems: AlgorithmicSystemCard[] = [
  ...
  },
  {
    ...
    description:
      'El projecte implementa un algoritme per a la predicció de la probabilitat d\'ocupació en espais o edificis, basat en dades de comportament i variables ambientals.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    description:
      'El projecte desenvolupa un algoritme per a l\'estimació dels resultats electorals basat en enquestes i altres dades rellevants.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    description:
      'El projecte desenvolupa un algoritme per gestionar la preinscripció escolar de manera eficient, tenint en compte diversos factors com la demanda i la ubicació dels centres educatius.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    description:
      'El projecte implementa un algoritme per predir l\'afluència de visitants en esdeveniments o llocs públics, basat en dades històriques i factors externs com el temps.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    description:
      'El projecte dissenya un sistema basat en algoritmes per gestionar la creació i renovació de carnets professionals, assegurant l\'autenticitat i l\'accés a serveis exclusius.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    title:
      'Algoritme per la gestió de les reserves d\'energia en un entorn residencial',
    description:
      'El projecte desenvolupa un algoritme per optimitzar la gestió de reserves d\'energia en habitatges, millorant l\'eficiència energètica i reduint el consum.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    title:
      'Algoritme per la gestió de les reserves d\'energia en un entorn residencial',
    description:
      'El projecte implementa un algoritme per la gestió de les reserves d\'energia en un entorn residencial, amb l\'objectiu d\'optimitzar l\'ús de l\'energia en funció de la demanda.',
  ...
  },
  {
    ...
    title:
      'Algoritme per la gestió de les reserves d\'energia en un entorn residencial',
    description:
      'El projecte dissenya un sistema que utilitza algoritmes per gestionar de manera intel·ligent les reserves d\'energia, millorant l\'autonomia i la sostenibilitat en entorns residencials.',
    categoryChips: ['Tecnologia, recerca i innovació'],
  ...
  },
  {
    ...
    title: 'Previsió d\'afluència de visitants',
    description:
      'El projecte implementa un algoritme per predir l\'afluència de visitants, utilitzant tècniques d\'anàlisi de dades per optimitzar l\'organització d\'esdeveniments.',
    categoryChips: ['Tecnologia, recerca i innovació'],
